...
var Swiper = ( function () {
	...
	var H = {
		...
		updateSlides: function () {
			...
			if ( s.centerInsufficientSlides ) {
				...
				g.forEach( ( t ) => {
					...
					( e -= x );
				const t =
					( s.slidesOffsetBefore || 0 ) +
					( s.slidesOffsetAfter || 0 );
				if ( e + t < r ) {
					const s = ( r - e - t ) / 2;
					m.forEach( ( e, t ) => {
						m[ t ] = e - s;
		...
		updateSlidesClasses: function () {
			const e = this,
				...
				l = ( e ) =>
					f( a, `.${ s.slideClass }${ e }, swiper-slide${ e }` )[ 0 ];
			let o, d, c;
			if ( r )
				if ( s.loop ) {
		...
		updateActiveIndex: function ( e ) {
			...
			if ( t.virtual && i.virtual.enabled && i.loop ) u = c( d );
				...
				Number.isNaN( s ) &&
					( s = Math.max( t.slides.indexOf( e ), 0 ) ),
			...
			if (
				( void 0 !== f &&
					...
					'auto' === i.slidesPerView &&
						...
						( ( g =
							g - a.slidesPerViewDynamic( 'previous', ! 0 ) + 1 ),
						( g = Math.max( g, 0 ) ) ) ),
	...
	var R = {
		loopCreate: function ( e ) {
			...
			const i = () => {
					f( a, `.${ s.slideClass }, swiper-slide` ).forEach(
						( e, t ) => {
	...
	function F( e ) {
		...
		if (
			...
			i.isScrolling ||
				( 'touchmove' === p.type &&
					i.preventTouchMoveFromPointerMove ) )
		)
	...
	const ge = [
		function ( e ) {
			...
			function c( e, t, a ) {
				...
				f( s.slidesEl, '.swiper-slide, swiper-slide' ).forEach(
					( e ) => {
						e.style[ y ] =
					...
					if (
						...
						if (
							E( t.el, `.${ t.params.slideClass }, swiper-slide` )
								.length > 0 &&
							0 ===
								E( t.el, `.${ t.params.slideActiveClass }` )
									.length
						)
							return;
						const a = t.el,
		...
		function ( e ) {
			...
			function r( e ) {
				...
				return e &&
					...
					t.isElement &&
					( ( s =
						t.el.querySelector( e ) ||
						t.hostEl.querySelector( e ) ),
					s )
					? s
					: ( e &&
							( 'string' == typeof e &&
		...
		function ( e ) {
			...
			function C( e ) {
				...
				return (
					!! e.target.matches( s ) ||
					t.slides.filter( ( t ) => t.contains( e.target ) ).length >
						0
				);
			}
			function P( e ) {
			...
			function L( e ) {
				if (
					( 'mouse' === e.pointerType && g.splice( 0, g.length ),
					! C( e ) )
				)
					return;
			...
			function $( e ) {
				...
				const n =
						( a.scale - l ) /
						( v.maxRatio - t.params.zoom.minRatio ),
				...
				( s.scale = A || $ ),
					...
					! e || ( 1 === l && A )
						...
						: ( ( L = v.slideEl.offsetWidth ),
						  ...
						  ( p = d + I / 2 - r ),
						  ( h =
								v.imageEl.offsetWidth ||
								v.imageEl.clientWidth ),
						  ( g =
			...
			const x = ( e, t, s ) => {
				...
				I = () => {
					...
					if (
						...
						( p = T( p ) ),
						c &&
							c.forEach( ( t ) => x( t, r, e.nextSlideMessage ) ),
						p &&
							p.forEach( ( t ) => x( t, r, e.prevSlideMessage ) ),
						E() )
					) {
